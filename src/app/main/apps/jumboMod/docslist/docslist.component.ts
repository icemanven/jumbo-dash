...
import {DocslistService} from './docslist.service';
import {ActivatedRoute} from '@angular/router';
import {Utilities} from '@utilities/utilities';

@Component({
    selector   : 'jum-servicios',
    templateUrl: './docslist.component.html',
    styleUrls  : ['./docslist.component.scss'],
    animations : fuseAnimations
})
export class DocslistComponent implements OnInit
{
    dataSource: FilesDataSource | null;
    displayedColumns = ['id', 'nombre', 'descripcion', 'costo'];
    ...
    constructor(
        private _EntidadesService: DocslistService,
    ...
    ngOnInit(): void
    {
        ...
        this.entidadesConst = Utilities.documentos.getType(this.docType);
...
export class FilesDataSource extends DataSource<any>
{
     ...
     * Constructor
     *
     * @param {DocslistService} _EntidadesService
